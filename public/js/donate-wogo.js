var insertForm22758401 = function() {
    var html22758401 = '<style text=\'text/css\'>' + 
...
'</style>' + 
'' + 
'<div id="donation-form-container" style="margin-left: 25px!important; padding-bottom: 50px;>' + 
...
'      <h3>Donation</h3>' + 
'      <div class="field radio 22760453 required" >' + 
'<label for="22760453"><input id="22760453" name="donation-level" class="required" type="radio" value="10.000000" maxlength="255"></input><span class="label">$10.00 - Your generosity will help provide orthopedic surgery for villagers.</span></label>' + 
'</div>' + 
'<div class="field radio 22760454 required" >' + 
'<label for="22760454"><input id="22760454" name="donation-level" class="required" type="radio" value="20.000000" maxlength="255"></input><span class="label">$20.00 - Your generosity will help provide orthopedic surgery for villagers.</span></label>' + 
'</div>' + 
'<div class="field radio 22760455 required" >' + 
'<label for="22760455"><input id="22760455" name="donation-level" class="required" type="radio" value="50.000000" maxlength="255"></input><span class="label">$50.00 - Your generosity will help provide orthopedic surgery for villagers.</span></label>' + 
'</div>' + 
'<div class="field radio 22760456 required" >' + 
'<label for="22760456"><input id="22760456" name="donation-level" class="required" type="radio" value="100.000000" maxlength="255"></input><span class="label">$100.00 - Your generosity will help provide orthopedic surgery for villagers.</span></label>' + 
'</div>' + 
'<div class="field radio 22760457 required" >' + 
'<label for="22760457"><input id="22760457" name="donation-level" class="required" type="radio" value="500.000000" maxlength="255"></input><span class="label">$500.00 - Your generosity will help provide orthopedic surgery for villagers.</span></label>' + 
'</div>' + 
'<div class="field radio 22760458 required" >' + 
'<label for="22760458"><input id="22760458" name="donation-level" class="required" type="radio" value="1000.000000" maxlength="255"></input><span class="label">$1,000.00 - Your generosity will help provide orthopedic surgery for villagers.</span></label>' + 
'</div>' + 
'<div class="field radio 22760459 required" >' + 
'<label for="22760459"><input id="22760459" name="donation-level" class="required" type="radio" value="5000.000000" maxlength="255"></input><span class="label">$5,000.00 - Your generosity will help provide orthopedic surgery for villagers.</span></label>' + 
'</div>' + 
...
'<label for="consent-all"><input id="consent-all" name="consent-all" type="checkbox" maxlength="255"></input><span class="label">I would like to receive or continue receiving updates from Adventures in Health, Education, and Agricultural Development, Inc.</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha22758401"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml22758401 = '<div class=\'donation-success\'>' +
                                                   '  <h2>Thank You for Your Donation!</h2>' +
                                                   '  <p>Your generous gift has been processed. We truly appreciate your continued support.</p>' + 
                                                    '\u003cdiv class=\"social-media-buttons\" style=\"margin-top:10px;\"\u003e\u003cdiv id=\"twitter-buttons\"\u003e\u003c/div\u003e\u003cdiv class=\"fb-like\" data-href=\"https://facebook.com/aheadinc\" data-layout=\"button_count\" data-show-faces=\"true\" style=\"padding-right: 10px;\" data-action=\"like\" \u003e\u003c/div\u003e\u003cdiv id=\"facebookShareOnly\" class=\"fb-share-button\" data-href=\"https://facebook.com/aheadinc\" data-layout=\"button_count\"\u003e\u003c/div\u003e\u003cscript type=\u0027text/javascript\u0027\u003edocument.getElementById(\u0027facebookShareOnly\u0027).setAttribute(\u0027data-href\u0027, window.location.href);\u003c/script\u003e\u003c/div\u003e \u003cscript\u003e\r\n                    if (navigator.userAgent.indexOf(\u0027Edge/\u0027) === -1) {\r\n                        !function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?\"http\":\"https\";if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+\"://platform.twitter.com/widgets.js\";fjs.parentNode.insertBefore(js,fjs);}}(document, \"script\", \"twitter-wjs\");\r\n                        var twitterButtons = document.getElementById(\u0027twitter-buttons\u0027);\r\n                        twitterButtons.innerHTML = \u0027\u003cdiv id=\"tweetButton\" style=\"float:left; margin-right:10px\"\u003e \u003ca href=\"https://twitter.com/share\" data-text=\"I just made a donation to @AHEADINC_ORG. You should too!\" class=\"twitter-share-button\"\u003eTweet\u003c/a\u003e \u003c/div\u003e\u003cdiv id=\"followButton\"\u003e \u003ca href=\"https://twitter.com/AHEADINC_ORG\" class=\"twitter-follow-button\"\u003eFollow\u003c/a\u003e \u003c/div\u003e\u0027;\r\n                        twitterButtons.style.height = \u002735px\u0027;\r\n                    }\r\n                \u003c/script\u003e \u003cdiv id=\"fb-root\"\u003e\u003c/div\u003e \u003cscript\u003e(function(d, s, id) { var js, fjs = d.getElementsByTagName(s)[0]; if (d.getElementById(id)) return; js = d.createElement(s); js.id = id; js.src = \"//connect.facebook.net/en_US/sdk.js#xfbml=1\u0026version=v2.8\"; fjs.parentNode.insertBefore(js, fjs); }(document, \u0027script\u0027, \u0027facebook-jssdk\u0027));\u003c/script\u003e ' + 
                                                    '</div>';( function($) {if (Bloomerang.useDonationId('22758401')) { 
                            Bloomerang.useProcessor('32769', 'StripeExpress', 'pk_live_iZYXFefCkt380zu63aqUIo7y');
                        } else {
                            html22758401 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                        }if (jQuery('#bloomerangForm22758401').length) {
                    
                if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                    html22758401 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                    ...
                    jQuery('#bloomerangForm22758401').after(html22758401);
                    
                     Bloomerang.Util.requireStripe(function() {
                          Bloomerang.Util.Stripe = Stripe('pk_live_iZYXFefCkt380zu63aqUIo7y');

                          Bloomerang.useKey('pub_874a0e31-1b16-11ec-b4ce-02c3084bcabb');
                   ...
                   window.captchaLoadCallback = function() {
                    ...
                    Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                        ...
                        function() {
                            ...
                            jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha22758401', { 'sitekey' : '6LfWj50cAAAAAFAGt1g52o6pZ87uY90L3rK-yxbT' }));
                        },
                        true,
                        true);
    ...
    Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
        ...
        formContainer.show();
        formContainer.html(successHtml22758401);
          ...
          jQuery(e).toggle();
            ...
            var startBloomerangLoad = function() {
                if (window.bloomerangLoadStarted == undefined) {
                    ...
                    script.src = 'https://crm.bloomerang.co/Content/Scripts/Api/Bloomerang-v2.js?nocache=2023-11-02';
                    document.getElementsByTagName('head')[0].appendChild(script);
                    waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm22758401(); })});
                }
                else {
                    waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm22758401(); })});
                }
