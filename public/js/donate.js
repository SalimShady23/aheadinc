var insertForm10170368 = function() {
  var html10170368 = '<style text=\'text/css\'>' + 
...
'      <h3>Donation</h3>' + 
'      <div class="field radio 10173440 required" >' + 
'<label for="10173440"><input id="10173440" name="donation-level" class="required" type="radio" value="25.000000" maxlength="255"></input><span class="label">$25.00 - Your generosity will help AHEAD Inc. further their mission in Africa</span></label>' + 
'</div>' + 
'<div class="field radio 10173441 required" >' + 
'<label for="10173441"><input id="10173441" name="donation-level" class="required" type="radio" value="50.000000" maxlength="255"></input><span class="label">$50.00 - Your generosity will help AHEAD Inc. further their mission in Africa</span></label>' + 
'</div>' + 
'<div class="field radio 10173442 required" >' + 
'<label for="10173442"><input id="10173442" name="donation-level" class="required" type="radio" value="100.000000" maxlength="255"></input><span class="label">$100.00 - Your generosity will help AHEAD Inc. further their mission in Africa</span></label>' + 
'</div>' + 
'<div class="field radio 10173443 required" >' + 
'<label for="10173443"><input id="10173443" name="donation-level" class="required" type="radio" value="250.000000" maxlength="255"></input><span class="label">$250.00 - Your generosity will help AHEAD Inc. further their mission in Africa</span></label>' + 
'</div>' + 
'<div class="field radio 10173445 required" >' + 
'<label for="10173445"><input id="10173445" name="donation-level" class="required" type="radio" value="500.000000" maxlength="255"></input><span class="label">$500.00 - Your generosity will help AHEAD Inc. further their mission in Africa</span></label>' + 
'</div>' + 
'<div class="field radio 10173446 required" >' + 
'<label for="10173446"><input id="10173446" name="donation-level" class="required" type="radio" value="1000.000000" maxlength="255"></input><span class="label">$1,000.00 - Your generosity will help AHEAD Inc. further their mission in Africa</span></label>' + 
'</div>' + 
...
'<option value="13313">Unrestricted</option>' + 
'<option value="5250048">Agriculture Fund</option>' + 
'<option value="5249024">Education Fund</option>' + 
'<option value="5248000">Health Fund</option>' + 
'</select>' + 
'</div>' + 
'' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha10170368"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml10170368 = '<div class=\'donation-success\'>' +
                                                 ...
                                                 '  <p>Your generous gift has been processed. We truly appreciate your continued support.</p>' + 
                                                  ...
                                                  '</div>';( function($) {if (Bloomerang.useDonationId('10170368')) { 
                          Bloomerang.useProcessor('32769', 'StripeExpress', 'pk_live_iZYXFefCkt380zu63aqUIo7y');
                      } else {
                          html10170368 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                      }if (jQuery('#bloomerangForm10170368').length) {
                  
              if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                  html10170368 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                  ...
                  jQuery('#bloomerangForm10170368').after(html10170368);
                 ...
                 window.captchaLoadCallback = function() {
                  ...
                  Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                      ...
                      function() {
                          ...
                          jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha10170368', { 'sitekey' : '6LfWj50cAAAAAFAGt1g52o6pZ87uY90L3rK-yxbT' }));
                      },
                      true,
                      true);
  ...
  Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
      ...
      formContainer.show();
      formContainer.html(successHtml10170368);
        ...
        jQuery(e).toggle();
          ...
          var startBloomerangLoad = function() {
              if (window.bloomerangLoadStarted == undefined) {
                  ...
                  waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm10170368(); })});
              }
              else {
                  waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm10170368(); })});
              }
