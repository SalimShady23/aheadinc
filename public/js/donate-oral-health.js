var insertForm22755328 = function() {
  var html22755328 = '<style text=\'text/css\'>' + 
...
'      <h3>Donation</h3>' + 
'      <div class="field radio 22757376 required" >' + 
'<label for="22757376"><input id="22757376" name="donation-level" class="required" type="radio" value="50.000000" maxlength="255"></input><span class="label">$50.00 - Your generosity will help fund the Dental Project at The Maruku Health Center</span></label>' + 
'</div>' + 
'<div class="field radio 22757377 required" >' + 
'<label for="22757377"><input id="22757377" name="donation-level" class="required" type="radio" value="100.000000" maxlength="255"></input><span class="label">$100.00 - Your generosity will help fund the Dental Project at the Maruku Health Center</span></label>' + 
'</div>' + 
'<div class="field radio 22757378 required" >' + 
'<label for="22757378"><input id="22757378" name="donation-level" class="required" type="radio" value="250.000000" maxlength="255"></input><span class="label">$250.00 - Your generosity will help fund the Dental Project at the Maruku Health Center</span></label>' + 
'</div>' + 
'<div class="field radio 22757379 required" >' + 
'<label for="22757379"><input id="22757379" name="donation-level" class="required" type="radio" value="500.000000" maxlength="255"></input><span class="label">$500.00 - Your generosity will help fund the Dental Project at the Maruku Health Center</span></label>' + 
'</div>' + 
'<div class="field radio 22757380 required" >' + 
'<label for="22757380"><input id="22757380" name="donation-level" class="required" type="radio" value="1000.000000" maxlength="255"></input><span class="label">$1,000.00 - Your generosity will help fund the Dental Project at the Maruku Health Center</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha22755328"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml22755328 = '<div class=\'donation-success\'>' +
                                                 ...
                                                 '  <p>Your generous gift has been processed. We truly appreciate your continued support.</p>' + 
                                                  ...
                                                  '</div>';( function($) {if (Bloomerang.useDonationId('22755328')) { 
                          Bloomerang.useProcessor('32769', 'StripeExpress', 'pk_live_iZYXFefCkt380zu63aqUIo7y');
                      } else {
                          html22755328 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                      }if (jQuery('#bloomerangForm22755328').length) {
                  
              if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                  html22755328 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                  ...
                  jQuery('#bloomerangForm22755328').after(html22755328);
                 ...
                 window.captchaLoadCallback = function() {
                  ...
                  Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                      ...
                      function() {
                          ...
                          jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha22755328', { 'sitekey' : '6LfWj50cAAAAAFAGt1g52o6pZ87uY90L3rK-yxbT' }));
                      },
                      true,
                      true);
  ...
  Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
      ...
      formContainer.show();
      formContainer.html(successHtml22755328);
        ...
        jQuery(e).toggle();
          ...
          var startBloomerangLoad = function() {
              if (window.bloomerangLoadStarted == undefined) {
                  ...
                  waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm22755328(); })});
              }
              else {
                  waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm22755328(); })});
              }
