var insertForm22758400 = function() {
  var html22758400 = '<style text=\'text/css\'>' + 
...
'      <h3>Donation</h3>' + 
'      <div class="field radio 22757381 required" >' + 
'<label for="22757381"><input id="22757381" name="donation-level" class="required" type="radio" value="25.000000" maxlength="255"></input><span class="label">$25.00 - Your generosity will help fund development projects at The Maruku Health Center</span></label>' + 
'</div>' + 
'<div class="field radio 22760448 required" >' + 
'<label for="22760448"><input id="22760448" name="donation-level" class="required" type="radio" value="50.000000" maxlength="255"></input><span class="label">$50.00 - Your generosity will help fund development projects at The Maruku Health Center</span></label>' + 
'</div>' + 
'<div class="field radio 22760449 required" >' + 
'<label for="22760449"><input id="22760449" name="donation-level" class="required" type="radio" value="100.000000" maxlength="255"></input><span class="label">$100.00 - Your generosity will help fund development projects at The Maruku Health Center</span></label>' + 
'</div>' + 
'<div class="field radio 22760450 required" >' + 
'<label for="22760450"><input id="22760450" name="donation-level" class="required" type="radio" value="250.000000" maxlength="255"></input><span class="label">$250.00 - Your generosity will help fund development projects at The Maruku Health Center</span></label>' + 
'</div>' + 
'<div class="field radio 22760451 required" >' + 
'<label for="22760451"><input id="22760451" name="donation-level" class="required" type="radio" value="500.000000" maxlength="255"></input><span class="label">$500.00 - Your generosity will help fund development projects at The Maruku Health Center</span></label>' + 
'</div>' + 
'<div class="field radio 22760452 required" >' + 
'<label for="22760452"><input id="22760452" name="donation-level" class="required" type="radio" value="1000.000000" maxlength="255"></input><span class="label">$1,000.00 - Your generosity will help fund development projects at The Maruku Health Center</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha22758400"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml22758400 = '<div class=\'donation-success\'>' +
                                                 ...
                                                 '  <p>Your generous gift has been processed. We truly appreciate your continued support.</p>' + 
                                                  ...
                                                  '</div>';( function($) {if (Bloomerang.useDonationId('22758400')) { 
                          Bloomerang.useProcessor('32769', 'StripeExpress', 'pk_live_iZYXFefCkt380zu63aqUIo7y');
                      } else {
                          html22758400 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                      }if (jQuery('#bloomerangForm22758400').length) {
                  
              if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                  html22758400 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                  ...
                  jQuery('#bloomerangForm22758400').after(html22758400);
                 ...
                 window.captchaLoadCallback = function() {
                  ...
                  Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                      ...
                      function() {
                          ...
                          jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha22758400', { 'sitekey' : '6LfWj50cAAAAAFAGt1g52o6pZ87uY90L3rK-yxbT' }));
                      },
                      true,
                      true);
  ...
  Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
      ...
      formContainer.show();
      formContainer.html(successHtml22758400);
        ...
        jQuery(e).toggle();
          ...
          var startBloomerangLoad = function() {
              if (window.bloomerangLoadStarted == undefined) {
                  ...
                  waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm22758400(); })});
              }
              else {
                  waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm22758400(); })});
              }
