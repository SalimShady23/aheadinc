var insertForm22495232 = function() {
  var html22495232 = '<style text=\'text/css\'>' + 
...
'      <h3>Donation</h3>' + 
'      <div class="field radio 22497280 required" >' + 
'<label for="22497280"><input id="22497280" name="donation-level" class="required" type="radio" value="50.000000" maxlength="255"></input><span class="label">$50.00 - Your gift will support the purchase of a basketball/volleyball court.</span></label>' + 
'</div>' + 
'<div class="field radio 22497281 required" >' + 
'<label for="22497281"><input id="22497281" name="donation-level" class="required" type="radio" value="100.000000" maxlength="255"></input><span class="label">$100.00 - Your gift will support the purchase of a basketball/volleyball court.</span></label>' + 
'</div>' + 
'<div class="field radio 22497282 required" >' + 
'<label for="22497282"><input id="22497282" name="donation-level" class="required" type="radio" value="250.000000" maxlength="255"></input><span class="label">$250.00 - Your gift will support the purchase of a basketball/volleyball court.</span></label>' + 
'</div>' + 
'<div class="field radio 22497283 required" >' + 
'<label for="22497283"><input id="22497283" name="donation-level" class="required" type="radio" value="500.000000" maxlength="255"></input><span class="label">$500.00 - Your gift will support the purchase of a basketball/volleyball court.</span></label>' + 
'</div>' + 
'<div class="field radio 22497284 required" >' + 
'<label for="22497284"><input id="22497284" name="donation-level" class="required" type="radio" value="1000.000000" maxlength="255"></input><span class="label">$1,000.00 - Your gift will support the purchase of a basketball/volleyball court.</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha22495232"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml22495232 = '<div class=\'donation-success\'>' +
                                                 ...
                                                 '  <p>Your generous gift has been processed. We truly appreciate your continued support.</p>' + 
                                                  ...
                                                  '</div>';( function($) {if (Bloomerang.useDonationId('22495232')) { 
                          Bloomerang.useProcessor('32769', 'StripeExpress', 'pk_live_iZYXFefCkt380zu63aqUIo7y');
                      } else {
                          html22495232 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                      }if (jQuery('#bloomerangForm22495232').length) {
                  
              if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                  html22495232 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                  ...
                  jQuery('#bloomerangForm22495232').after(html22495232);
                 ...
                 window.captchaLoadCallback = function() {
                  ...
                  Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                      ...
                      function() {
                          ...
                          jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha22495232', { 'sitekey' : '6LfWj50cAAAAAFAGt1g52o6pZ87uY90L3rK-yxbT' }));
                      },
                      true,
                      true);
  ...
  Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
      ...
      formContainer.show();
      formContainer.html(successHtml22495232);
        ...
        jQuery(e).toggle();
          ...
          var startBloomerangLoad = function() {
              if (window.bloomerangLoadStarted == undefined) {
                  ...
                  waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm22495232(); })});
              }
              else {
                  waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidationAndStripe(function() { insertForm22495232(); })});
              }
